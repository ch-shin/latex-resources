% Optional math commands --- modified from https://github.com/goodfeli/dlbook_notation.
...
\newcommand{\ymv}[0]{\hat{y}_{\text{MV}}}
\newcommand{\ylm}[0]{\hat{y}_{\text{LM}}}
\newcommand{\highlight}[1]{\cellcolor{blue!20}{\textbf{#1}}}
